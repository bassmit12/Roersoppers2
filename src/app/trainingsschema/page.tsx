...
const trainingSessions: TrainingSession[] = [
  ...
  },
  {
    day: "Zaterdag",
    time: "08:00 - 09:00",
    group: "Jongeren recreatief/Jongeren Wedstrijd/Wedstrijdmasters en Masters 1",
    location: "Zwembad De Roer",
  },
  {
    day: "Zaterdag",
...
daysOfWeek.forEach(day => {
  scheduleByDay[day] = trainingSessions.filter(session => session.day === day);
});
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-slate-50">
      ...
      <main className="pt-20">
        ...
        <section ref={ref} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-24">
          {/* Week Calendar Grid */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
                ...
                {daysOfWeek.map((day) => (
                  <div
                    ...
                    className={`p-4 text-center font-bold text-slate-700 border-r border-slate-200 last:border-r-0 ${
                      scheduleByDay[day].length > 0 ? 'bg-gradient-to-b from-cyan-50 to-blue-50' : 'bg-slate-50'
                    }`}
                  >
                    <div className="text-sm sm:text-base">{day}</div>
                    {scheduleByDay[day].length > 0 && (
                      <div className="mt-1 text-xs text-cyan-600 font-semibold">
                        {scheduleByDay[day].length} {scheduleByDay[day].length === 1 ? 'training' : 'trainingen'}
                      </div>
                    )}
                  </div>
                ))}
                        ...
                        {scheduleByDay[day].map((session, index) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 mb-2">
                              ...
                              <span className="font-bold text-xs">{session.time}</span>
                            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="flex gap-4">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Zorg dat je minimaal <strong>15 minuten voor aanvang</strong> aanwezig bent
                </p>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Breng altijd je <strong>zwemspullen</strong> mee: zwembroek/badpak, handdoek, badmuts en zwembril
                </p>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Bij afwezigheid graag <strong>vooraf doorgeven</strong> aan de trainer
                </p>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Wijzigingen worden tijdig via de <strong>website en nieuwsbrief</strong> gecommuniceerd
                </p>
              </div>
            </div>
          </motion.div>
